...
//    private int lasttimelength=0;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_GYROSCOPE) {
            ...
            sensordata="gyroscope||"+sX+"||" + sY+"||"+ sZ+"||"+SensorTime+"||"+SensorTime2+"\n";
            ...
            sensordata="accelerometer||"+sX+"||" + sY+"||"+ sZ+"||"+SensorTime+"||"+SensorTime2+"\n";
            ...
            sensordata="magnetometer||"+sX+"||" + sY+"||"+ sZ+"||"+SensorTime+"||"+SensorTime2+"\n";

        }
        //写文件部分
        data+=sensordata; //要写入的数据
        if(data.length()>=10000)//数据更新频率
        {
            writeappend(mContext,"test.txt",data);
            data="";
        }
    }
